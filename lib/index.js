    ...
    try {
        switch (option) {
            ...
            case "base":
                ...
                {
                    const response = (await helper.askQuestion(`your application will use jwt [y/n]?`)).toLowerCase()
                    if (response.tolo == 'y')
                        jwt = true
                    else
                        jwt = false
                ...
                {
                    const response = (await helper.askQuestion(`your application will work with files [y/n]?`)).toLowerCase()
                    if (response == 'y')
                        files = true
                    else
                        files = false
