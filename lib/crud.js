...
const comments = ["//organize the line codes and include in module.exports"]
...
${includeComment ? comments[0] + "\n" : ""} const ${controllerName} = require('./controllers/${crudName}')
...
const ${repositoryName} = require('../models/${crudName}')
